                        ...
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" name="su_contact_no" class="form-control input_pass" placeholder="Contact Number"
                        ...
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="contact_no" class="form-control input_user" placeholder="Contact No" 
                                    pattern="\d{10}" title="Please enter exactly 10 digits" required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
